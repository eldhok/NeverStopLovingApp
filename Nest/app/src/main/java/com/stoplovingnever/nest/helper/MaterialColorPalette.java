package com.stoplovingnever.nest.helper;

/**
 * Created by eldho on 14/2/17.
 */
...
public class MaterialColorPalette {
    ...
    public static final int TEAL_500 = Color.parseColor("#E91E63");
    public static final int GREEN_500 = Color.parseColor("#E91E63");
    public static final int LIGHT_GREEN_500 = Color.parseColor("#E91E63");
    public static final int LIME_500 = Color.parseColor("#E91E63");
    public static final int YELLOW_500 = Color.parseColor("#E91E63");
    public static final int AMBER_500 = Color.parseColor("#E91E63");
    public static final int ORANGE_500 = Color.parseColor("#E91E63");
    public static final int DEEP_ORANGE_500 = Color.parseColor("#E91E63");
