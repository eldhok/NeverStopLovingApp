...
import com.stoplovingnever.nest.activity.MainActivity;
...
import static com.stoplovingnever.nest.activity.CrushFragment.chatRoomArrayList;

/**
 * Created by eldho on 24/2/17.
 */

public class MyFcmListenerService extends FirebaseMessagingService {
    private String TAG = MyFcmListenerService.class.getSimpleName();
    ...
    public void onMessageReceived(RemoteMessage message){
     ...
     //   Object moduleid= ((ArrayMap) data).get("data");
     //   Log.e(TAG, "moduleid: "+ moduleid);
        ...
        Boolean isBackground = Boolean.valueOf(data.get("is_background").toString());
        ...
        processUserMessage(title, isBackground, d);
...
/*
        ...
        switch (Integer.parseInt(flag)) {
            ...
            case Config.PUSH_TYPE_USER:
                // push notification is specific to userPUSH_TYPE_USER=2
    ...
    private void processUserMessage(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                String status=datObj.getString("status");
                ...
                if (!status.equals("4")) {
                    ...
                    if (status.equals("3")) {
                        for (ChatRoom cr : chatRoomArrayList) {
                            if (cr.getChat_id().equals(chatRoomId)) {
                                ...
                                cr.setLast_msg_s_id(message.getId());
                    ...
                    if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                        ...
                        if (status.equals("3")) {
                            showNotificationMessage(getApplicationContext(), title, "Message" + " : " + message.getMessage(), message.getCreatedAt(), resultIntent);
                        } else {
                ...
                else //for handling likes
                {
                    JSONObject mObj = datObj.getJSONObject("message");
                    Intent resultIntent = new Intent(getApplicationContext(), MainActivity.class);


                        showNotificationMessage(getApplicationContext(), title, "Notification" + " : " + mObj.getString("message"), mObj.getString("created_at"), resultIntent);
